...
FilesToEnrich <- c("/home/isglobal.lan/ldiez/data/WS_INMA/Methylation_INMA/PACE/Pla_IQ_LD/results/INMA_202200601_Output/NOUsignificativeresultsMAIN/verbal_sig_4ann.txt") ## mira't aquest arxiu i veus com està formatejat per a que el pugui llegir easier i adaptes els teus
...
results_folder <- NA
results_gwama <- NA
results_enrich <- "enrichment_verbal"
